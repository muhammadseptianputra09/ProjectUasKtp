...
import unu.jogja.Ktp.coba.exceptions.NonexistentEntityException;
import unu.jogja.Ktp.coba.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("unu.jogja_Ktp_jar_0.0.1-SNAPSHOTPU");
